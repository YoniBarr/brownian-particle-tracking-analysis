...
stitchtraj = struct('frames',cell(1,length(L)),'nmatch',[],'x',[],'y',[],'L',[],'ntraj',[],'nbfstitch',[],'fstitch',[],'dXstitch',[],'dVstitch',[],'dfstitch',[],'nbstitch',[]);
...
for kt=1:length(L)
    ...
    if jstitch~=0
        ...
        stitchtraj(kt).dVstitch = dVstitch(d:d+2*jstitch-1);
