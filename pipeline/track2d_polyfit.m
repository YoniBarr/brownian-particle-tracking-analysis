function [traj,tracks]=track2d_polyfit(folderout,FileName,data,maxdist,lmin,flag_pred,npriormax,porder,flag_conf)

% 03/2019 - Thomas Basset 
%
% Track particles on 2D images doing closest neighbour tracking. Only when the is a conflict, predictive tracking is realized by fitting
